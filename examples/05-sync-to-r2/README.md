...
```bash
npx tsx examples/05-sync-to-r2/index.ts
```
...
- [04-branching](../04-branching/) - Version control with branches
- [Dataset examples](../README.md#dataset-examples) - Large-scale data processing
