/**
 * Payload CMS View Components
 *
 * These components are designed to integrate with Payload CMS admin panel
 * as custom views via the admin.components.views configuration.
 */
