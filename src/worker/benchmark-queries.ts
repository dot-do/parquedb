...
export interface BenchmarkQuery {
  ...
  description: string
  /** Equivalent scan filter (for comparison baseline) */
  scanFilter?: Filter
}
...
export const IMDB_QUERIES: BenchmarkQuery[] = [
  ...
  // Range queries (SST index)
  {
    ...
    scanFilter: { startYear: { $gte: 2020, $lte: 2025 } },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { startYear: { $gte: 2010, $lt: 2020 } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { startYear: { $gte: 2000, $lt: 2010 } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { averageRating: { $gte: 8.0 } },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { averageRating: { $gte: 7.0 } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { averageRating: { $gte: 6.0, $lt: 7.0 } },
    selectivity: 'low',
  ...
  // Compound queries (hash + range)
  {
    ...
    scanFilter: { titleType: 'movie', startYear: { $gte: 2020 } },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { titleType: 'movie', averageRating: { $gte: 8.0 } },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { titleType: 'tvSeries', startYear: { $gte: 2010, $lt: 2020 } },
    selectivity: 'medium',
...
export const ONET_QUERIES: BenchmarkQuery[] = [
  ...
  // Range queries (SST index)
  {
    ...
    scanFilter: { socCode: { $gte: '15-0000.00', $lt: '16-0000.00' } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { socCode: { $gte: '29-0000.00', $lt: '30-0000.00' } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { socCode: { $gte: '11-0000.00', $lt: '12-0000.00' } },
    selectivity: 'medium',
  ...
  // Compound queries
  {
    ...
    scanFilter: { jobZone: 5, dataValue: { $gte: 4.0 } },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { socCode: { $gte: '15-0000.00', $lt: '16-0000.00' }, scaleId: 'IM' },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { jobZone: 4, dataValue: { $gte: 5.0 } },
    selectivity: 'high',
  ...
  // Scan baselines
  {
    ...
    filter: { jobZone: 5 },
    selectivity: 'high',
    description: 'Baseline scan without index',
  },
  {
...
export const UNSPSC_QUERIES: BenchmarkQuery[] = [
  ...
  // Range queries (SST index) - codes are strings in the data
  {
    ...
    scanFilter: { code: { $gte: '43000000', $lt: '44000000' } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { code: { $gte: '44000000', $lt: '45000000' } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { code: { $gte: '50000000', $lt: '51000000' } },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { code: { $gte: '43210000', $lt: '43220000' } },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { code: { $gte: '43230000', $lt: '43240000' } },
    selectivity: 'high',
  ...
  // Hierarchy drill-down queries
  {
    ...
    scanFilter: { code: { $gte: '43100000', $lt: '43110000' } },
    selectivity: 'high',
  ...
  },
  {
    ...
    scanFilter: { code: { $gte: '43101500', $lt: '43101600' } },
    selectivity: 'high',
  ...
  // Compound queries
  {
    ...
    scanFilter: { segmentCode: '43', status: 'active' },
    selectivity: 'medium',
  ...
  },
  {
    ...
    scanFilter: { segmentCode: '80', code: { $gte: '80100000', $lt: '80200000' } },
    selectivity: 'high',
  ...
  },
  {
    ...
    category: 'scan',
    expectedIndex: 'none',
    filter: { code: { $gte: '43000000', $lt: '44000000' } },
    selectivity: 'medium',
    description: 'Baseline scan without index',
  },
]
